 ...
 * haya dos tipos diferentes de clientes, tipo 0 y tipo 1 (por ejemplo) y el barbero pele
 * de forma alternativa a los clientes, es decir, a uno del tipo 0, uno del tipo 1, uno 
 * del tipo 0, etc.
 */
