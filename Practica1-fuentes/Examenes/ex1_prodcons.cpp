 ...
 * Sobre el problema del productor-consumidor, en este caso hay dos hebras
 * productoras que cuentan el número de items que ha producido cada una
 * y al final de su ejecución imprimen el número de items producidos en cada
 * hebra. Además de esto, se crea una hebra impresora que cada 5 items consumidos
 * imprime un mensaje informativo por pantalla.
 */ 
...
void  funcion_hebra_productora1(  )
{
   ...
   cout << "----------------------------------------------------------------------------" << endl;
   cout << "\n-->El numero total de articulos suministrados por el primer productor es: " << product1 << endl << endl;
   cout << "----------------------------------------------------------------------------" << endl;
}
...
void  funcion_hebra_productora2(  )
{
   ...
   cout << "----------------------------------------------------------------------------" << endl;
   cout << "\n-->El numero total de articulos suministrados por el segundo productor es: " << product2 << endl << endl;
   cout << "----------------------------------------------------------------------------" << endl;
}
